...
class CalibrationPage(QtWidgets.QWidget):
    ...
    def update_data(self, d):
        enable = self._get(d, "calib_enable", "enable", "g_lm_calibhmi_enable", default=False)
        mode_empty = self._get(d, "calib_mode_empty", "mode_empty", "g_lm_calibhmi_modeempty", default=True)
        step = self._get(d, "calib_step", "step", "g_lm_calibhmi_step", default=STEP_IDLE)
        status_text = self._get(d, "calib_status_text", "status_text", "g_lm_calibhmi_statustext", default="Calibration idle.")
        curr_alpha = self._get(d, "calib_curr_alpha_deg", "curr_alpha_deg", "g_lm_calibhmi_curralphadeg")
        curr_l = self._get(d, "calib_curr_l_mm", "curr_l_mm", "g_lm_calibhmi_currl_mm")
        target_alpha = self._get(d, "calib_target_alpha_deg", "target_alpha_deg", "g_lm_calibhmi_targetalphadeg")
        target_l = self._get(d, "calib_target_l_mm", "target_l_mm", "g_lm_calibhmi_targetl_mm")
        err_alpha = self._get(d, "calib_err_alpha_deg", "err_alpha_deg", "g_lm_calibhmi_erralphadeg")
        err_l = self._get(d, "calib_err_l_mm", "err_l_mm", "g_lm_calibhmi_errl_mm")
        active_i_alpha = self._get(d, "calib_active_i_alpha", "active_i_alpha", "g_lm_calibhmi_active_ialpha")
        active_i_l = self._get(d, "calib_active_i_l", "active_i_l", "g_lm_calibhmi_active_il")
        alpha_tol = self._get(d, "calib_alpha_tol_deg", "alpha_tol_deg", "g_lm_calibhmi_alphatoldeg")
        l_tol = self._get(d, "calib_l_tol_mm", "l_tol_mm", "g_lm_calibhmi_ltol_mm")
        stable_req = self._get(d, "calib_stable_cycles_req", "stable_cycles_req", "g_lm_calibhmi_stablecyclesreq", default=10)
        stable_count = self._get(d, "calib_stable_count", "stable_count", default=0)
        in_tol = self._get(d, "calib_in_tolerance", "in_tolerance", "g_lm_calibhmi_intolerance", default=False)
        is_stable = self._get(d, "calib_is_stable", "is_stable", "g_lm_calibhmi_isstable", default=False)
        ready_store = self._get(d, "calib_ready_to_store", "ready_to_store", "g_lm_calibhmi_readytostore", default=False)
        last_store_ok = self._get(d, "calib_last_store_ok", "last_store_ok", "g_lm_calibhmi_laststoreok", default=False)
        last_stored_value = self._get(d, "calib_last_stored_value", "last_stored_value", "g_lm_calibhmi_laststoredvalue")
        m_ref = self._get(d, "m_ref_kg", "calib_m_ref_kg", "g_m_ref_kg")
        m_model = self._get(d, "m_model_kg", "g_m_model_kg")
        m_empty_interp = self._get(d, "m_empty_interp_kg", "calib_m_empty_interp_kg")
        m_net = self._get(d, "m_net_kg", "calib_m_net_kg")
        done_nodes = self._get(d, "calib_done_nodes", "done_nodes")
