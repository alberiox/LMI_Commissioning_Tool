...
class GeometryPage(QtWidgets.QWidget):
    def __init__(self, parent=None):
        ...
        self.boom_len = InfoRow("Length validate")
        self.boom_ang_meas = InfoRow("Angle meas")
        self.boom_ang = InfoRow("Angle validate")
        ...
        self.ballast_pos = InfoRow("Position validate")
        self.ballast_ang_meas = InfoRow("Angle meas")
        self.ballast_ang = InfoRow("Angle validate")
